...
//if it is hollow make it solid, and this hike to users's "bookmarks" array
// if it is solid, make it hollow, and remove the hike from the users's "bookmark" aeeay
//Hints: theres is a ".includes()" to see if an element is in a JS array

// //
// functionupdateBookmark(hikeDocID)
...
//     } else{
//         currentUser.set({
//             bookmarks: firebaseConfig.firestore.FieldValus.arrayUnion(hikeDocID),
//         },
//         {
//             merge: true
//         })
//         .then(function(){
//             console.log("This bookmark is removed for " + currrentUser);
